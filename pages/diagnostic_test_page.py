...
class DiagnosticTestPage:
    ...
    wait_for_diagonstic_test = (AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().text("Quick 10 min Diagnostic test")')
    ...
    def wait_for_diagnostic_test_page(self):
        wait_for_visibility(self.driver,self.wait_for_diagonstic_test)
    ...
    def wait_for_diagnostic_speaking(self):
        ...
        self.driver.find_element.click(*self.select_technology).click()
